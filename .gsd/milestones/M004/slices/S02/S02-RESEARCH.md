# S02 Research: Compliance dashboard run selector
...
The failure is environmental/tooling-related, not slice-specific. Because the unavailable tool prevents both initial dispatch and individual retry, this blocker file records the failed research state for S02 as requested after subagent failure.
