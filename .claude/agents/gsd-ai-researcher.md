...
<required_reading>
Read `C:/Users/smati/VS Code Projects/pfizer-externship/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
