...
<required_reading>
Read `C:/Users/smati/VS Code Projects/pfizer-externship/.claude/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
