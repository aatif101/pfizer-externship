...
<!-- For checkpoint task examples and patterns, see @C:/Users/smati/VS Code Projects/pfizer-externship/.claude/get-shit-done/references/checkpoints.md -->
...
See `C:/Users/smati/VS Code Projects/pfizer-externship/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/Users/smati/VS Code Projects/pfizer-externship/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/Users/smati/VS Code Projects/pfizer-externship/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
