...
```bash
INIT=$(node "C:/Users/smati/VS Code Projects/pfizer-externship/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/smati/VS Code Projects/pfizer-externship/.claude/get-shit-done/templates/spec.md.
