...
```
Task(
  prompt="Read C:/Users/smati/VS Code Projects/pfizer-externship/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/smati/VS Code Projects/pfizer-externship/.claude/get-shit-done/templates/VALIDATION.md`
